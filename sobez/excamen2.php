...
//  Выведите отдельную строку для каждой машины, вида: 
//  Машина "НАЗВАНИЕ МАШИНЫ" стоит в "НАЗВАНИЕ ГАРАЖА"
...
echo $cars[0]['name'] . ' ' . $garages[7]['name'] . "<br>";
echo $cars[1]['name'] . ' ' . $garages[1]['name'] . "<br>";
echo $cars[2]['name'] . ' ' . $garages[7]['name'] . "<br>";
